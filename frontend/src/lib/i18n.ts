...
const translations = {
	zh: {
		...
		subscriptionNote: '請使用與 ReelScript 相同的 Email 付款',
		freePriceLabel: '免費',
		features: '功能',
	...
	en: {
		...
		subscriptionNote: 'Please use the same email as your ReelScript account',
		freePriceLabel: 'Free',
		features: 'Features',
