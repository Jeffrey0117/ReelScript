...
const translations = {
	zh: {
		...
		issueGrammar: '文法',
		issueWordChoice: '用字',
		issueNaturalness: '自然度',
		issuePronunciation: '發音',
		practiceMode: '跟讀模式',
		results: '分析結果',
		nextSentence: '下一句',
		prevSentence: '上一句',
		uploadLimit: '檔案大小上限 50MB',
		...
		displayBoth: '對照',
		issueCount: '{n} 個問題',
		discourseAnalysis: '表達分析',
		analyzingDiscourse: '分析表達中...',
		topic: '主旨',
		structureAnalysis: '結構分析',
		currentStructure: '目前結構',
		structureProblems: '結構問題',
		structureSuggestion: '建議架構',
		rewrittenScript: '修改稿',
		expressionTips: '表達技巧',
		clarity: '清晰度',
		organization: '組織性',
	...
	en: {
		...
		uploadAudio: 'Upload Recording',
		recording: 'Recording',
		sessions: 'Sessions',
		noSessions: 'No sessions yet. Upload a recording to get started!',
		...
		original: 'Original',
		corrected: 'Corrected',
		nativeAlt: 'Native Alternative',
		issueGrammar: 'Grammar',
		issueWordChoice: 'Word Choice',
		issueNaturalness: 'Naturalness',
		issuePronunciation: 'Pronunciation',
		...
		analyzingDiscourse: 'Analyzing...',
		topic: 'Topic',
		structureAnalysis: 'Structure',
		currentStructure: 'Current',
		structureProblems: 'Issues',
		structureSuggestion: 'Suggestion',
		rewrittenScript: 'Revised Script',
		expressionTips: 'Tips',
		clarity: 'Clarity',
		...
		discourseQuotaCost: '3 credits per analysis',
	},
} as const;
